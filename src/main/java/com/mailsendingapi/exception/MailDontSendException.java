package com.mailsendingapi.exception;

import org.springframework.http.HttpStatus;

/**
 * Exception containing relevant information for mail dont send Exception API errors.
 *
 * @author Samuel Stalschus
 */
public class MailDontSendException extends ApiException {
     ...
     * @param e cause
     */
    public MailDontSendException(Throwable e) {
        super(
                BAD_REQUEST_CODE,
     ...
     * @param e cause.
     */
    public MailDontSendException(String message, Throwable e) {
     ...
     * @param message custom message.
     */
    public MailDontSendException(String message) {
